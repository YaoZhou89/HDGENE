HDGENE_AA = function(CV= NULL,GD=NULL,GM=NULL,Y=NULL,seqQTN = NULL,p.threshold = NULL,maxIter=3,GWAS=NULL,LD.pruning = F,position.pruning=NULL,LD=0.7){
  # AA
  ...
  if(is.null(GWAS)){
    ...
    GWAS = HDGENE_AA_full(CV= CV, GD = GD,GM = GM,Y=Y,seqQTN = seqQTN,p.threshold = p.threshold, position.pruning = position.pruning)
